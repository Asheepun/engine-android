...
void Model_initFromFile_mesh(Model *model_p, const char *path, AAssetManager *assetManager_p){

	long int fileSize;
	char *data = getFileData_mustFree(path, &fileSize, assetManager_p);
...
void BoneModel_initFromFile(BoneModel *model_p, const char *path, AAssetManager *assetManager_p){
...
void Shader_init(Shader *shader_p, const char *name, const char *vertexShaderPath, const char *fragmentShaderPath, AAssetManager *assetManager_p){
