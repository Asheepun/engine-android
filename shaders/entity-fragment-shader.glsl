...
in float input_colorChangeRadius;
in vec3 input_colorChangeDirection;
in vec4 input_colorChangeColor;
...
void main(){
	...
	if(length(input_localPosition - input_colorChangeDirection) < input_colorChangeRadius){
		FragColor = input_colorChangeColor;
	}
