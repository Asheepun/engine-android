 ...
 *
 * Commandline:
 *    --api='glx=1.4' --extensions='GLX_EXT_swap_control,GLX_EXT_swap_control_tear' c --loader
 *
 * Online:
 *    http://glad.sh/#api=glx%3D1.4&extensions=GLX_EXT_swap_control%2CGLX_EXT_swap_control_tear&generator=c&options=LOADER
 *
 */
